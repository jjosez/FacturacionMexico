...
namespace FacturaScripts\Plugins\FacturacionMexico\Lib\Cfdi\Customer\Factory;
 ...
 */
class CustomerCfdiServiceFactory
{
    /**
     ...
     *
     * @param Empresa $company
     * @return CustomerCfdiService
     */
    public static function createCustomerCfdiService(Empresa $company): CustomerCfdiService
    {
        return new CustomerCfdiService(
